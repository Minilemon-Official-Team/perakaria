...
CREATE TABLE content_entries_v3 (
  id TEXT PRIMARY KEY,
  content_type TEXT NOT NULL CHECK (content_type IN ('site_settings','theme_settings','section_settings','hero','about','expertise','skill','service','portfolio','client','contact')),
...
INSERT INTO content_entries_v3 SELECT * FROM content_entries;
DROP TABLE content_entries;
ALTER TABLE content_entries_v3 RENAME TO content_entries;
